...
const ROUTER_ADDRESS = "0xdd6E85bC17cF6851A9919A19E5f354Af0D312A6B"; // need to update this
...
module.exports = async ({ deployments }) => {
    ...
    // await token.approve(modeNFT.address, ethers.utils.parseEther("1000000"));
    // await modeNFT.mint();
